...
import { MilestoneTypeMetadata } from "src/services/database/models/ActivityModel";
import { activityTypeAttributes } from "src/utils/global";

export const MilestoneCard: FunctionComponent<ActivityCardProps> = ({
  activity
}) => {
  const typeMetadata = activity.typeMetadata as MilestoneTypeMetadata;
  ...
  return (
    ...
    >
      ...
      <View className="flex-1">
        ...
        <Card.Caption>{typeMetadata.milestone}</Card.Caption>
      </View>
